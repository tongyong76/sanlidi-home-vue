<?php
class LineCateAction extends BaseAction{
	
	public function index(){
		$cate_mod=M('GoodsCate');
	...
	public function edit(){
		...
		if ($_POST['submit']){
			...
			$this->success('修改成功！',U('LineCate/index'));
